...
export default function AdminLeads() {
  ...
  const handleQuickWhatsApp = (phone, name) => {
                        ...
                        <td className="py-4 px-6">
                          <div className="flex gap-2">
                            ...
                            >
                              ...
                              {sendingMessage === booking.id ? 'Sending...' : 'Send API'}
                            </button>
                            <button
                              onClick={() => handleQuickWhatsApp(booking.whatsappNumber?.replace(/\D/g, ''), booking.fullName)}
